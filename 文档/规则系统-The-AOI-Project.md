## 规则系统 [](https://aoi.fedstack.org/rule.html#%E8%A7%84%E5%88%99%E7%B3%BB%E7%BB%9F)

## 概述 [](https://aoi.fedstack.org/rule.html#%E6%A6%82%E8%BF%B0)
...
### 规则集（RuleSet） [](https://aoi.fedstack.org/rule.html#%E8%A7%84%E5%88%99%E9%9B%86-ruleset)

每一处**规则设置**都可以配置一个**规则集**。一个规则集可以视作一个流水线。对于给定的上下文，AOI系统将按照规则集中定义的 `rules` 逐个匹配，若均匹配失败，则使用 `defaults` 中定义的投影器。

### 规则（Rule） [](https://aoi.fedstack.org/rule.html#%E8%A7%84%E5%88%99-rule)

每一个规则都包含两个部分：`match` 和 `returns`。`match` 用于定义规则匹配器，`returns` 用于定义规则投影器。

若匹配器成功匹配，则将返回对应的投影器。

### 规则匹配器（Matcher） [](https://aoi.fedstack.org/rule.html#%E8%A7%84%E5%88%99%E5%8C%B9%E9%85%8D%E5%99%A8-matcher)
...
### 规则投影器（Projector） [](https://aoi.fedstack.org/rule.html#%E8%A7%84%E5%88%99%E6%8A%95%E5%BD%B1%E5%99%A8-projector)
...
## 支持的规则设置 [](https://aoi.fedstack.org/rule.html#%E6%94%AF%E6%8C%81%E7%9A%84%E8%A7%84%E5%88%99%E8%AE%BE%E7%BD%AE)

### 比赛 [](https://aoi.fedstack.org/rule.html#%E6%AF%94%E8%B5%9B)

#### 提交规则（solution） [](https://aoi.fedstack.org/rule.html#%E6%8F%90%E4%BA%A4%E8%A7%84%E5%88%99-solution)
...
#### 参赛规则（participant） [](https://aoi.fedstack.org/rule.html#%E5%8F%82%E8%B5%9B%E8%A7%84%E5%88%99-participant)
...
### 题目 [](https://aoi.fedstack.org/rule.html#%E9%A2%98%E7%9B%AE)

#### 提交规则（solution） [](https://aoi.fedstack.org/rule.html#%E6%8F%90%E4%BA%A4%E8%A7%84%E5%88%99-solution-1)
